...
export const Default: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Basic thumbnail grid showing static thumbnail images. Lightweight alternative to OSDThumbnailBrowser without OpenSeadragon integration.',
            },
        },
    },
}
...
export const WithAuthentication: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story:
                    'Configure the server URL and log in via DsaAuthManager; ThumbnailGrid picks up `dsaAuthStore` headers and API base automatically. You can still pass `apiBaseUrl` / `apiHeaders` to override.',
            },
        },
    },
}
