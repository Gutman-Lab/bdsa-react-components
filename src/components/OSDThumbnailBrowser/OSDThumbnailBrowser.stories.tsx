...
import { OSDThumbnailBrowser } from './OSDThumbnailBrowser'
import { DsaAuthManager } from '../DsaAuthManager/DsaAuthManager'

const meta: Meta<typeof OSDThumbnailBrowser> = {
    title: 'Components/OSDThumbnailBrowser',
    component: OSDThumbnailBrowser,
    tags: ['autodocs'],
    argTypes: {
        folderId: {
            control: 'text',
...
export default meta
type Story = StoryObj<typeof OSDThumbnailBrowser>
...
export const WithAuthentication: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story:
                    'Configure the server URL and log in via DsaAuthManager; the browser uses `dsaAuthStore` for Girder-Token headers and API base. Override with props when needed.',
            },
        },
    },
}
            ...
            <div style={{ display: 'flex', height: '800px', gap: '16px' }}>
                ...
                >
                    ...
                    <p style={{ fontSize: '12px', color: '#666', marginBottom: '12px' }}>
                        This panel shows the array of item IDs being passed to the OSDThumbnailBrowser component.
...
export const DifferentSizes: Story = {
    render: () => {
        const [size] = useState<'s' | 'm' | 'l' | 'xl'>('l')
