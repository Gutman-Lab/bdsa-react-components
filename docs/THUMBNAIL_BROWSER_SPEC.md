...
The thumbnail browser provides a paginated, responsive grid view of DSA items (whole slide images) with optional annotation overlays. It's designed to be reusable across different contexts (folder browsing, model training image viewing, annotation-filtered views).
